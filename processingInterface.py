"""
processingInterface: an interface to allow pitch and frequency information
to be displayed visually using pyprocessing which is based on OpenGL
"""
...
osc = RecursiveOscillator(157.0, bfr.buffer_size, osc_amp, sr, bd)
...
def draw():
    ...
    if(volume != 0):
        ...
        fill(0, 0, 255, 0)          # No fill colour for the circle
